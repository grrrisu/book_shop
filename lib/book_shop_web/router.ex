defmodule BookShopWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, html: {BookShopWeb.Layouts, :root}
  ...
  if Application.compile_env(:book_shop, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: BookShopWeb.Telemetry
    end
  end
end
